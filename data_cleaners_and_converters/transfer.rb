...
coors = File.open("../../data/cut_coordinates_1.txt","w")
aw = File.read("../../data/cut_gois_1.txt")
allw = JSON.parse(aw)["words"]

coordinates = Hash.new(0)
allw.each do |key,value|
  filename = "../../data/cut_gois_1/#{key}"
...
allw.each do |key,value|
  ifile = "../../data/cut_gois_1/#{key}"
  ofile = "../../data/trans_gois_1/#{key}"
