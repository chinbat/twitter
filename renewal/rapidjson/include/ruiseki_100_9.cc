...
/*
  ...
  return 0;
*/
  FILE * log = fopen("../../../../data/ruiseki_100_9.txt","a");  
  string users[11177];
  string line;
  ...
  int uc = 0;
  string word_input = "../../../../data/ruiseki_100_9.goi";
  ...
  //cout<<INT_MAX<<endl;return 0;
    ...
    stringstream js;
    js << user;
    FILE * res = fopen(("../../../../data/res_ruiseki_100_9/"+js.str()+".json").c_str(),"w");
...
*/
    ...
    fclose(log);
    log = fopen("../../../../data/ruiseki_100_9.txt","a");  
  }
return 0;
}
