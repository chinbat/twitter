...
/*
  ...
  return 0;
*/
  FILE * log = fopen("../../../../data/ruiseki_10_7_hist.txt","a");  
  string users[11177];
  string line;
  ...
  int uc = 0;
  string word_input = "../../../../data/ruiseki_10_7_hist.goi";
  ...
  //cout<<INT_MAX<<endl;return 0;
    ...
    stringstream js;
    js << user;
    FILE * res = fopen(("../../../../data/res_ruiseki_10_7_hist/"+js.str()+".json").c_str(),"w");
...
*/
    ...
    fclose(log);
    log = fopen("../../../../data/ruiseki_10_7_hist.txt","a");  
  }
return 0;
}
