...
/*
  ...
  return 0;
*/
  FILE * log = fopen("../../../../data/ruiseki_10_7_userbase.txt","a");  
  string users[11177];
  string line;
  ...
  string word_input = "../../../../data/ruiseki_10_7.goi";
  ...
  //cout<<INT_MAX<<endl;return 0;
    ...
    stringstream js;
    js << user;
    FILE * res = fopen(("../../../../data/res_tokucho_userbase/"+js.str()+".json").c_str(),"w");
...
*/
    ...
    fclose(log);
    log = fopen("../../../../data/ruiseki_10_7_userbase.txt","a");  
  }
return 0;
}
